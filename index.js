...
program
  .command('generate-values-embedding-vector')
  .description('Generate embedding vectors for all values records in the database')
  .action(generateValuesEmbeddingVector);

program
  .command('generate-embedding-from-text <text>')
  .description('Generate embedding vector for a given text and print it to the console')
  .action(generateEmbeddingFromText);
